...
export type CatalogueCollectionQueryVariables = StorefrontAPI.Exact<{
...
export type CatalogueCollectionQuery = {
...
export type VarietyAvailabilityQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type VarietyAvailabilityQuery = {
  collections: {
    nodes: Array<
