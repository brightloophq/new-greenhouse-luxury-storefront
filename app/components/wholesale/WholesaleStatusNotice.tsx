...
const COPY: Record<DeniedStatus, NoticeCopy> = {
  pending: {
    eyebrow: 'Business Account · application received',
    pill: 'Under review',
    tone: 'wait',
    title: 'Your Business Account application is under review',
    lead: 'Thank you for applying for a Business Account. Our team is verifying the business details you submitted, including your CRA/TRN, to confirm your business eligibility.',
  ...
  more_information_required: {
    eyebrow: 'Business Account · one more step',
    pill: 'Action needed',
    tone: 'info',
    title: 'We need a little more information',
    lead: 'We’ve started reviewing your Business Account application and need a few more details before we can confirm your account. It only takes a moment to sort out.',
    note: 'Get in touch and a member of our team will help you complete your application.',
    contact: true,
  },
  rejected: {
    eyebrow: 'Business Account · application update',
    pill: 'Not approved',
    tone: 'closed',
    title: 'We couldn’t approve this application',
    lead: 'Thank you for your interest in a Business Account with The New Greenhouse. After reviewing your submission, we’re unable to open a Business Account at this time.',
