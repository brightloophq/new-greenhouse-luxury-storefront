...
const DELUXE: HomeContent = {
  ...
  hero: {
    ...
    body: 'Hand-composed signature arrangements — gift-ready and delivered with a personal touch — for anniversaries, birthdays, romance, sympathy, and every gesture in between.',
    primary: {label: 'Shop the Collection', to: '/collections/luxury-bouquets'},
  ...
  featured: {
    ...
    title: 'The right flowers for every moment.',
    cards: [
      {
        title: 'Anniversary',
